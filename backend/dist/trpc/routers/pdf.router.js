...
exports.pdfRouter = (0, trpc_1.router)({
    ...
    generateAndDownloadPDF: trpc_1.protectedProcedure
        ...
        try {
            ...
            const pdfBuffer = await (0, pdf_service_1.generatePDF)(resumeData, fileName);
            ...
            console.log(`Credit deducted for user ${user.id}. Remaining credits: ${updatedUser.credits}`);
