...
const envSchema = zod_1.z.object({
    ...
    STRIPE_PUBLISHABLE_KEY: zod_1.z.string().min(1, "STRIPE_PUBLISHABLE_KEY is required for billing"),
    STRIPE_WEBHOOK_SECRET: zod_1.z.string().min(1, "STRIPE_WEBHOOK_SECRET is required for webhook verification"),
